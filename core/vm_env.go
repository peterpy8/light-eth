...
func (self *VMEnv) Call(me vm.ExternalLogicRef, addr helper.Address, data []byte, gas, price, value *big.Int) ([]byte, error) {
	return Call(self, me, addr, data, gas, price, value)
}
func (self *VMEnv) CallCode(me vm.ExternalLogicRef, addr helper.Address, data []byte, gas, price, value *big.Int) ([]byte, error) {
	return CallCode(self, me, addr, data, gas, price, value)
}

func (self *VMEnv) DelegateCall(me vm.ExternalLogicRef, addr helper.Address, data []byte, gas, price *big.Int) ([]byte, error) {
	return DelegateCall(self, me, addr, data, gas, price)
}

func (self *VMEnv) Create(me vm.ExternalLogicRef, data []byte, gas, price, value *big.Int) ([]byte, helper.Address, error) {
