...
/*
This cmd generates GPL license headers on top of all source files.
...
var (
	...
	authorsFileHeader = "# This is the official list of siotchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The Siotchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-siotchain library"
	}
	return "the go-siotchain library"
}
