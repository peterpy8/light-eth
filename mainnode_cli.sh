...
echo `build/bin/siotchain_cli --rpcport 8000 --request "getNodeInfo"`

echo "-----------------------------------------------------------------------------"
echo "test the cases when input format is incorrect"
echo "test case 2: incorrect input format for getNewAccount -------------"
echo `build/bin/siotchain_cli --rpcport 8888 --request "getNewAccount"`

echo "-----------------------------------------------------------------------------"
echo "test for correct input"
nodeInfo=`build/bin/siotchain_cli --rpcport 8888 --request "getNodeInfo"`
echo "test case 3: get node information ---------------"
echo $nodeInfo


acct1=`build/bin/siotchain_cli --rpcport 8888 --request "getNewAccount 123"`
echo "test case 4: create new account acct1 --------------"
echo $acct1

echo "test case 5: unlock acct1"
echo `build/bin/siotchain_cli --rpcport 8888 --request " unlockAccount $acct1 123"`

acct2=`build/bin/siotchain_cli --rpcport 8888 --request "getNewAccount 123"`
echo "test case 6: create new account acct2 --------------"
echo $acct2

echo "test case 7: unlock acct2 ------------"
echo `build/bin/siotchain_cli --rpcport 8888 --request " unlockAccount $acct2 123"`

echo "test case 8: get account list ------------"
echo `build/bin/siotchain_cli --rpcport 8888 --request "getAccounts"`

echo "test case 9: get acct1 balance before mining -------------"
echo `build/bin/siotchain_cli --rpcport 8888 --request "getbalance $acct1"`

echo "test case 10: set acct1 as miner"
echo `build/bin/siotchain_cli --rpcport 8888 --request "setMiner $acct1"`
...
echo `build/bin/siotchain_cli --rpcport 8888 --request "sendAsset $acct1 $acct2 1000000"`
...
echo `build/bin/siotchain_cli --rpcport 8888 --request "getbalance $acct2 "`
