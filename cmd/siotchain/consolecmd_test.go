...
func TestConsoleWelcome(t *testing.T) {
	...
	// Start a siotchain console, make sure it's cleaned up and terminate the console
	geth := runGeth(t,
...
func TestIPCAttachWelcome(t *testing.T) {
	...
	if runtime.GOOS == "windows" {
		...
		ipc = filepath.Join(ws, "siotchain.ipc")
	}
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint string) {
	// Attach to a running siotchain note and terminate immediately
