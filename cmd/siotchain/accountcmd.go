...
var (
	walletCommand = cli.Command{
		...
		Description: `
    siotchain wallet import /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    siotchain --password <passwordfile> account new
...
`,
			},
			{
				...
				ArgsUsage: "<address>",
				Description: `
    siotchain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    siotchain --password <passwordfile> account update <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    siotchain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    siotchain --password <passwordfile> account import <keyfile>
